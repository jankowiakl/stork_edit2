...
export const ANNOTATION_FIELDS = Object.freeze([
  ...
  { key:"Altitude", db:"altitude", label:"Altitude class", type:"select", options:["low","medium","high"], help:"Qualitative altitude category for airborne observations." },
  ...
  { key:"Above_ground", db:"above_ground", label:"Above ground (m)", type:"derived", help:"GPS altitude minus ground elevation." },
  { key:"Height_class_100m", db:"height_class_100m", label:"100-m height class", type:"derived", help:"100-m class derived from height above ground." },
  ...
  { key:"Activity_class", db:"activity_class", label:"Activity class", type:"select", options:["foraging","roosting","night_roosting","death","fly"], help:"Primary behaviour visible in the photograph." },
  { key:"Agriculture_type", db:"agriculture_type", label:"Agriculture type", type:"select", options:["non_agricultural","arable_unspecified","mixed_cropping_or_agricultural_mosaic","meadow_or_pasture","flooded_or_water_managed_field","teff_cultivation","maize_cultivation","not_determinable"], help:"Agricultural habitat or non-agricultural context." },
  { key:"Foraging_habitat_group", db:"foraging_habitat_group", label:"Foraging habitat", type:"select", options:["agricultural_land","waste_disposal_site","wetland_or_waterbody","natural_or_seminatural_open_habitat","built_or_industrial_area"], help:"Broad habitat used for foraging." },
  { key:"Roost_site_group", db:"roost_site_group", label:"Roost site", type:"select", options:["artificial_structure","ground_open_site","tree_or_shrub","nest","wetland_or_water_site"], help:"Substrate or setting of roosting observations." },
  ...
  { key:"Water_presence_class", db:"water_presence_class", label:"Water presence", type:"select", options:["no_water_visible","small_water","large_waterbody"], help:"Presence and approximate scale of visible water." },

...
export const FIELD_INFO=Object.freeze({
  ...
  Pheno_period:info(
    ...
    {plainDefinition:"Annual-cycle or phenological period assigned to the observation.",howToRecord:"Select the period assigned to this observation from the available movement and seasonal context.",optionHelp:{fledging:"Local post-fledging period.","pre-migratory":"Period before autumn departure.",A_migration:"Autumn migration.",Wintering:"Wintering or non-breeding period."}}
  ),
  Residence:info(
    {dataType:"Categorical text",unit:"yes/no",sourceRole:"Movement-state annotation",definition:"Binary assignment to a residence/stopover segment versus a non-residence/transit segment."},
    {plainDefinition:"Whether the observation belongs to a residence or stopover segment, or to transit.",howToRecord:"Use the residence/stopover assignment available for the observation.",optionHelp:{yes:"Residence or stopover.",no:"Non-residence or transit."},important:"Do not invent a distance or time threshold. The historical workbook does not define the analytical segmentation rule."}
  ),
  Feather_perc:info(

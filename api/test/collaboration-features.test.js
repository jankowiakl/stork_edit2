...
test("the GitHub Pages application is installable as a PWA",()=>{
  ...
  assert.match(ui,/rel="manifest" href="manifest\.webmanifest\?v=2026-09-02-56"/);
...
test("responsive defaults and mobile editor controls remain compact",()=>{
  ...
  assert.match(ui,/<input id="editorEnvDesc" data-field="Env_desc_en" type="text" autocomplete="off" role="combobox"/);
});

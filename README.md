...
- browser-persisted interface font scaling from 100% to 160%, with a 125% desktop default and compact 100% mobile default;
...
- one focused annotation exception at the browsing limit: the lock screen opens exactly one unfinished photo until it is completed, while explicit administrator tasks remain accessible;
